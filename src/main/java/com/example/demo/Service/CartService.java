...
public List<ViewCart> getOrder(){
		
		try {
			User u=(User)session.getAttribute("user");
			List<ViewCart> list=new ArrayList<>();
			
				List<Cart> cart=repo.findCartUser(u.getId(),true);
				 ...
				 for(Cart c:cart) {
					 ...
					 if(c.getItem_type().equalsIgnoreCase("menu")) {
						 ...
						 Menu m=menu.getById(c.getItem_id());
						  ...
						  car.setPath("/images/menu/"+m.getTitle()+".jpeg");
						  car.setQuantity(c.getQuantity());
						  System.out.println("--------c.getUpdateDateTime()--menu----"+c.getUpdateDateTime());
						   	SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");  
						    String strDate= formatter.format(c.getUpdateDateTime());  
						  car.setDate(strDate);
					 ...
					 if(c.getItem_type().equalsIgnoreCase("package")) {
						...
						car.setCost(m.getCost());
						  ...
						  car.setUser_id(u.getId());
						  car.setPath("/images/packages/"+m.getTitle()+".jpeg");
						  System.out.println("--------c.getUpdateDateTime()--pacakge----"+c.getUpdateDateTime());
						  SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");  
						    String strDate= formatter.format(c.getUpdateDateTime());  
						  car.setDate(strDate);
					 }
